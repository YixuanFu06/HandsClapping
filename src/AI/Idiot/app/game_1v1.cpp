...
int main() {
    ...
    std::cout << "Game between you and AI " << policy.GetName() << " starts." << std::endl;
    while (battle_field.GetMemberNum() > 1) {
        ...
        Game::Action *AI_action = policy.GetAction(player_health, player_energy, AI_health, AI_energy);
    ...
    if (battle_field.GetMemberNum() < 1) {
        ...
        std::cout << "Game over and you lose! You cannot even beat an idiot AI!" << std::endl;
    }
